...
func TestCatalogItem(t *testing.T) {
	...
	th.Equals(t, "2018-10-24 23:38:47.713775685 +0100 BST", item.ModificationTime.String())
...
func TestCatalogItem2(t *testing.T) {
	...
	th.Equals(t, "2018-10-25 07:37:27.809296805 +0100 BST", item.ModificationTime.String())
